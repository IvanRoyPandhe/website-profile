...
<div class="container mx-auto px-4 py-8">
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-4">Himpunan Mahasiswa (HIMAGIZ)</h1>
        <p class="text-gray-600">Kegiatan dan program kerja Himpunan Mahasiswa Program Studi Gizi</p>
    </div>
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="text-gray-500">Data kegiatan HIMAGIZ akan segera diperbarui.</p>
        </div>
    @endif
</div>
@endsection