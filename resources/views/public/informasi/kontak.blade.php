    ...
    <div class="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <nav class="mb-8">
            <div class="flex items-center space-x-2 text-blue-200">
                ...
                <span class="text-yellow-300 font-medium">Kontak</span>
            </div>
        </nav>
        ...
        <div class="text-center">
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                Hubungi <br>
                <span class="text-yellow-400">Kami</span>
            </h1>
            <p class="text-xl text-blue-100 max-w-3xl mx-auto font-medium">
                Kami siap membantu Anda dengan informasi Program Studi Ilmu Gizi
            </p>
        </div>
    </div>
</section>
        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-blue-500 overflow-hidden">
                ...
                <form action="{{ route('kontak.submit') }}" method="POST" class="space-y-6">
                    ...
                    <button type="submit" 
                            class="w-full bg-blue-500 hover:bg-blue-600 text-white py-4 px-6 rounded-lg font-medium transition-colors shadow-md">
                        Kirim Pesan
                    </button>
                </form>
                </div>
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-1">Alamat Kampus</h4>
                                    <p class="text-gray-600 text-sm">Kampus 1: Jl. Sumatera No. 101 GKB</p>
                                    <p class="text-gray-600 text-sm">Kampus 2: Jl. Proklamasi 54</p>
                                    <p class="text-gray-600 text-sm">Gresik, Jawa Timur</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">(031) 3981918</p>
                                    <p class="text-gray-600 text-sm">Bagian Akademik: Ext. 123</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">gizi@umg.ac.id</p>
                                    <p class="text-gray-600 text-sm">info@umg.ac.id</p>
                                </div>
                            </div>
                ...
                <!-- Social Media -->
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-8 shadow-lg">
                    <h3 class="text-xl font-bold mb-6">Ikuti Media Sosial Kami</h3>
                    <div class="grid grid-cols-2 gap-4">
                        <a href="#" class="flex items-center p-3 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
