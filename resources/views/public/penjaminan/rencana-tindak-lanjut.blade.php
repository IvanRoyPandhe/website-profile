...
@section('title', 'Rencana Tindak Lanjut - Program Studi Ilmu Gizi UM Gresik')
    ...
    <div class="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <nav class="mb-8">
            <div class="flex items-center space-x-2 text-blue-200">
                ...
                <span class="text-yellow-300 font-medium">Rencana Tindak Lanjut</span>
            </div>
        </nav>
        ...
        <div class="text-center">
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                Rencana <br>
                <span class="text-yellow-400">Tindak Lanjut</span>
            </h1>
            <p class="text-xl text-blue-100 max-w-3xl mx-auto font-medium">
                Laporan rencana tindak lanjut Program Studi Ilmu Gizi
            </p>
        </div>
    </div>
</section>
        ...
        @else
            <div class="text-center py-20">
                <div class="bg-white rounded-2xl shadow-lg p-12 max-w-lg mx-auto border-t-4 border-green-500">
                    ...
                    <p class="text-gray-600 text-lg">Laporan rencana tindak lanjut akan segera tersedia.</p>
                </div>
            </div>
        @endif
    </div>
