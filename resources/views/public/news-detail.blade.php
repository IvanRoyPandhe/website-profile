...
@section('title', $news->title . ' - Nursing Study Program')
...
<section class="bg-gray-100 py-4">
    <div class="container mx-auto px-4">
        <nav class="text-sm">
            <a href="{{ route('home') }}" class="text-nursing-blue hover:text-blue-700">Home</a>
            <span class="mx-2 text-gray-500">/</span>
            <a href="{{ route('news') }}" class="text-nursing-blue hover:text-blue-700">News</a>
            <span class="mx-2 text-gray-500">/</span>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <header class="mb-8">
                <div class="flex items-center justify-between mb-4">
                    <span class="bg-nursing-blue text-white px-4 py-2 rounded-full text-sm font-semibold">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4 fade-in">
                    {{ $news->title }}
                </h1>
                
                <p class="text-xl text-gray-600 leading-relaxed fade-in">
                    {{ $news->excerpt }}
                </p>
            </header>
            ...
            <!-- Article Content -->
            <div class="prose prose-lg max-w-none mb-8 fade-in">
                {!! $news->content !!}
            </div>
            ...
            @if($news->gallery && count($news->gallery) > 0)
                <div class="mb-8 fade-in">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Gallery</h3>
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($news->gallery as $image)
                            <img src="{{ Storage::url($image) }}" 
                                 alt="Gallery image" 
                                 class="w-full h-48 object-cover rounded-lg shadow hover-scale cursor-pointer"
            ...
            <!-- Share Buttons -->
            <div class="border-t border-b border-gray-200 py-6 mb-8 fade-in">
...
<section class="py-12 bg-gray-50">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-8 text-nursing-blue">Related Articles</h2>
                ...
                <article class="bg-white rounded-lg shadow-lg overflow-hidden hover-scale">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-lg font-bold mb-3 text-gray-800">
                            <a href="{{ route('news.detail', $related->slug) }}" class="hover:text-nursing-blue transition-colors">
                                {{ $related->title }}
                            </a>
                        </h3>
                        <p class="text-gray-600 text-sm mb-4">{{ Str::limit($related->excerpt, 80) }}</p>
                        <a href="{{ route('news.detail', $related->slug) }}" 
                           class="text-nursing-blue hover:text-blue-700 font-semibold text-sm">
                            Read More →
                        </a>
                    </div>
                </article>
