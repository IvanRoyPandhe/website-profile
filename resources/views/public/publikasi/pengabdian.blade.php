...
@section('title', 'Pengabdian - Program Studi Ilmu Gizi UM Gresik')
    ...
    <div class="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <nav class="mb-8">
            <div class="flex items-center space-x-2 text-blue-200">
                ...
                <span class="text-yellow-300 font-medium">Pengabdian</span>
            </div>
        </nav>
        ...
        <div class="text-center">
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                Pengabdian <br>
                <span class="text-yellow-400">Masyarakat</span>
            </h1>
            <p class="text-xl text-blue-100 max-w-3xl mx-auto font-medium">
                Kontribusi nyata Program Studi Gizi untuk masyarakat
            </p>
        </div>
    </div>
</section>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-purple-500 overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6">
                            <div class="flex items-center">
                                ...
                                <h2 class="text-2xl font-bold">Pengabdian Tahun {{ $tahun }}</h2>
                            </div>
                        </div>
                                ...
                                <table class="min-w-full">
                                    <thead>
                                        <tr class="border-b-2 border-gray-200">
                                            ...
                                            <th class="px-6 py-4 text-left text-sm font-bold text-gray-900 uppercase tracking-wider">Judul PkM</th>
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        @foreach($pengabdian as $item)
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 text-sm text-gray-900 break-words">{{ $item->judul_pkm }}</td>
        ...
        @else
            <div class="text-center py-20">
                <div class="bg-white rounded-2xl shadow-lg p-12 max-w-lg mx-auto border-t-4 border-purple-500">
                    ...
                    <p class="text-gray-600 text-lg">Data pengabdian kepada masyarakat akan segera tersedia.</p>
                </div>
            </div>
        @endif
    </div>
