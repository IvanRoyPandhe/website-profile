...
<body class="bg-gray-50">
    <!-- Navigation -->
    <nav class="bg-nursing-blue shadow-lg sticky top-0 z-50">
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-2">
                <div class="flex items-center">
                    <img src="{{ asset('umg-logo.png') }}" alt="UMG Logo" class="h-12 w-auto object-contain">
                </div>
                
                <div class="hidden lg:flex items-center space-x-4">
                    <a href="{{ route('home') }}" class="text-white hover:text-blue-200 transition-all duration-200 py-2 px-3 rounded-md hover:bg-white/10 font-medium {{ request()->routeIs('home') ? 'text-blue-200 font-semibold bg-white/20' : '' }}">Beranda</a>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-1 w-64 bg-white rounded-lg shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="py-2">
                                <a href="{{ route('visi-misi') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-nursing-blue hover:text-white transition-colors border-b border-gray-50 last:border-b-0">Visi Keilmuan dan Tujuan</a>
                ...
                <!-- Mobile menu button -->
                <div class="lg:hidden">
                    <button id="mobile-menu-button" class="text-white hover:text-blue-200 p-2 rounded-md hover:bg-white/10 transition-colors">
            ...
            <!-- Mobile menu -->
            <div id="mobile-menu" class="hidden lg:hidden pb-4 space-y-1 border-t border-gray-100 mt-3 pt-3">
                <a href="{{ route('home') }}" class="block py-3 px-4 text-white hover:text-gray-100 hover:bg-white/20 rounded-md transition-colors {{ request()->routeIs('home') ? 'text-nursing-blue font-semibold bg-blue-50' : '' }}">Beranda</a>
                ...
                <div class="mobile-dropdown">
                    ...
                    <div class="mobile-dropdown-content hidden pl-4 space-y-1">
                        <a href="{{ route('visi-misi') }}" class="block py-1 text-sm text-gray-600 hover:text-gray-100">Visi Keilmuan dan Tujuan</a>
    ...
    <!-- Footer -->
    <footer class="bg-nursing-blue text-white py-12">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">Program Studi Ilmu Gizi</h3>
                    <p class="text-blue-200">Mencetak nutrisionis yang mandiri, kreatif, profesional dan unggul berasaskan Islam.</p>
                </div>
                <div>
                    <h4 class="font-semibold mb-4">Quick Links</h4>
                    <ul class="space-y-2 text-blue-200">
                        <li><a href="{{ route('home') }}" class="hover:text-white transition-colors">Beranda</a></li>
                        <li><a href="{{ route('visi-misi') }}" class="hover:text-white transition-colors">Visi & Misi</a></li>
                        <li><a href="{{ route('profile-dosen') }}" class="hover:text-white transition-colors">Profile Dosen</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-blue-200">
                        <li>Kampus 1: Jl. Sumatera No. 101 GKB</li>
                        <li>Kampus 2: Jl. Proklamasi 54</li>
                        <li>Gresik, Jawa Timur</li>
                        <li>Universitas Muhammadiyah Gresik</li>
                    </ul>
                </div>
                <div>
            ...
            <div class="border-t border-blue-600 mt-8 pt-8 text-center text-blue-200">
                <p>&copy; {{ date('Y') }} Program Studi Ilmu Gizi UM Gresik. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function showSlide(index) {
            ...
            if (currentActive && currentActive !== nextSlide) {
                ...
                // Start fade in next slide after slight delay
                setTimeout(() => {
        ...
        // Auto-advance carousel with global duration
        const slideDuration = {{ \App\Models\CarouselSetting::getDuration() }};
